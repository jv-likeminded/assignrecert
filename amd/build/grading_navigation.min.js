  ...
  return (
    ...
    (g.prototype._loadAllUsers = function () {
      var a = this._region.find("[data-action=change-user]"),
        c = a.attr("data-assignmentrecertid"),
        d = a.attr("data-groupid");
      e.call([
        {
          methodname: "mod_assignrecert_list_participants",
          args: { assignrecertid: c, groupid: d, filter: "", onlyids: !0 },
    ...
    (g.prototype._checkClickOutsideConfigureFilters = function (b) {
      ...
      if (!c.is(b.target) && 0 === c.has(b.target).length) {
        ...
        c.hide(),
          ...
          a(document).off("click.mod_assignrecert_grading_navigation");
      }
    }),
          ...
          function (b, c) {
            ...
            a.each(this._filters, function (a, b) {
              "submitted" == b
                ...
                ? "1" == c.submitted && (d = !1)
                : "requiregrading" == b
                ? "0" == c.requiregrading && (d = !1)
                : "grantedextension" == b &&
                  "0" == c.grantedextension &&
                  (d = !1);
            }),
              d &&
    ...
    (g.prototype._refreshCount = function () {
      ...
      if (isNaN(d) || d <= 0)
        ...
        g && (f += 1);
        var h = { x: f, y: g };
        c.get_string("xofy", "mod_assignrecert", h)
          .done(
            function (a) {
