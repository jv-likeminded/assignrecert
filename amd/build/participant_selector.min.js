define(["core/ajax", "jquery", "core/templates"], function (a, b, c) {
  return {
    processResults: function (a, b) {
      return b;
    },
    transport: function (d, e, f, g) {
      var h = b(d).attr("data-assignmentrecertid"),
            ...
            return (
              b.each(a, function (a, f) {
                ...
                k.filter_submitted && !f.submitted && (i = !1),
                  ...
                  k.filter_grantedextension && !f.grantedextension && (i = !1),
                  i &&
                    ...
                    d.push(
                      c
                        .render(
                          "mod_assignrecert/list_participant_user_summary",
                          g
                        )
                        .then(function (a) {
