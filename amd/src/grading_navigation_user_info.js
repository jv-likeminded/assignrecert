 ...
 *
 * @module     mod_assignrecert/grading_navigation_user_info
...
define([
  ...
  /**
   * Get the assignmentrecert id
   *
   * @private
   * @method _getAssignmentId
   * @return {Integer} assignmentrecert id
   */
  UserInfo.prototype._getAssignmentId = function () {
    return this._region.attr("data-assignmentrecertid");
  };
      ...
      .done(
        function (html, js) {
          ...
          if (userid < 0) {
            // Render the template.
            templates
              .render("mod_assignrecert/grading_navigation_no_users", {})
              .done(
                function (html, js) {
                  // Update the page.
                  this._region.fadeOut(
          ...
          if (typeof this._userCache[userid] !== "undefined") {
            ...
            var requests = ajax.call([
              {
                methodname: "mod_assignrecert_get_participant",
                args: {
                  userid: userid,
                  assignrecertid: assignmentId,
                  embeduser: true,
                },
              },
            ]);
              ...
              function (context) {
                ...
                if (context.user) {
                  ...
                  $.each(identityfields, function (i, k) {
                    if (
                      typeof context.user[k] !== "undefined" &&
                      context.user[k] !== ""
                    ) {
                ...
                templates
                  .render(
                    "mod_assignrecert/grading_navigation_user_summary",
                    context
                  )
                  .done(
                    function (html, js) {
