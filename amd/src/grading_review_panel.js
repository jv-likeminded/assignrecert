 ...
 *
 * @module     mod_assignrecert/grading_review_panel
 ...
 * @since      3.1
 */
define(["jquery", "mod_assignrecert/grading_events"], function (
  $,
  GradingEvents
) {
  /**
  ...
  GradingReviewPanel.prototype.registerEventListeners = function () {
    ...
    toggleReviewPanelButton.keydown(
      function (e) {
    ...
    docElement.on(
      GradingEvents.EXPAND_REVIEW_PANEL,
      function () {
        this.expandPanel();
      }.bind(this)
    );
