 ...
 *
 * @module     mod_assignrecert/grading_actions
...
define(["jquery", "mod_assignrecert/grading_events"], function (
  ...
  GradingActions.prototype.registerEventListeners = function () {
    ...
    if (this.hasReviewPanelElement()) {
      ...
      collapseReviewPanelButton.click(
        function (e) {
      ...
      collapseReviewPanelButton.keydown(
        function (e) {
      ...
      collapseGradePanelButton.click(
        function (e) {
      ...
      collapseGradePanelButton.keydown(
        function (e) {
          if (!e.metaKey && !e.shiftKey && !e.altKey && !e.ctrlKey) {
            if (e.keyCode === 13 || e.keyCode === 32) {
              this.collapseGradePanel();
