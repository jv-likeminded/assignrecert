...
require_once($CFG->dirroot . '/mod/assignrecert/assignmentrecertplugin.php');
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class assignrecert_submission_plugin extends assignrecert_plugin {
     ...
     * @param stdClass $submission the assignrecert_submission record being submitted.
     ...
     *
     * @param stdClass|false $submission - assignrecert_submission data if any
     ...
     *
     * @param stdClass $submission - assignrecert_submission data
     * @return void
     */
