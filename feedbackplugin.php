...
/**
 * Abstract class for feedback_plugin inherited from assignrecert_plugin abstract class.
 *
 * @package   mod_assignrecert
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class assignrecert_feedback_plugin extends assignrecert_plugin {
     ...
     *
     * A grading action is a page that is not specific to a user but to the whole assignmentrecert.
     * @return array - An array of action and description strings.
