...
/**
 * Assignment Recert quick grading form
 *
 * @package   mod_assignrecert
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_assignrecert_quick_grading_form extends moodleform {
    /**
    ...
    public function definition() {
        ...
        // Buttons.
        $savemessage = get_string('saveallquickgradingchanges', 'assignrecert');
