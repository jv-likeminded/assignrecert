...
Feature: Submit assignmentrecert without group
  As a teacher
  I should be able to prevent students submitting team assignmentrecerts as members of the default group
  ...
  Scenario: Switch between group modes
    ...
    And the following "activities" exist:
      | activity | course | idnumber | name                     | intro                       | assignrecertsubmission_onlinetext_enabled | preventsubmissionnotingroup | teamsubmission |
      | assignrecert   | C1     | assign1  | Allow default group      | Test assignmentrecert description | 1                                   | 0                           | 1              |
      | assignrecert   | C1     | assign2  | Require group membership | Test assignmentrecert description | 1                                   | 1                           | 1              |
      | assignrecert   | C2     | assign2  | Require group membership | Test assignmentrecert description | 1                                   | 1                           | 1              |
      | assignrecert   | C3     | assign2  | Require group membership | Test assignmentrecert description | 1                                   | 1                           | 1              |
    ...
    And the following "group members" exist:
      ...
      | student3 | GC31  |
      | student3 | GC32  |
    # Student 1 can only submit assignmentrecert in course 2.
    When I log in as "student1"
    And I am on "Course 1" course homepage
    And I follow "Allow default group"
    Then I should not see "Not a member of any group"
    And I should not see "This assignmentrecert requires submission in groups. You are not a member of any group"
    And I should see "Nothing has been submitted for this assignmentrecert"
    And I press "Add submission"
    And I set the following fields to these values:
      | Online text | I'm the student submission |
    And I press "Save changes"
    And I press "Submit assignmentrecert"
    And I press "Continue"
    And I should see "Submitted"
    And I follow "Course 1"
    And I follow "Require group membership"
    And I should see "None" in the "Group" "table_row"
    And I should see "This assignmentrecert requires submission in groups. You are not a member of any group"
    And I should see "Nothing has been submitted for this assignmentrecert"
    ...
    And I should see "Submitted"
    And I log out
    # Teacher should see student 1 and student 2 has submitted assignmentrecert.
    ...
    And I should see "The assignmentrecert requires submission in groups. You are a member of more than one group."
    And I should see "Nothing has been submitted for this assignmentrecert"
    And I should not see "Add submission"
    And I log out
    And I log in as "teacher1"
