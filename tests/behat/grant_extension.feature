...
Feature: Grant an extension to an offline student
  ...
  @javascript
  Scenario: Granting an extension to an offline assignmentrecert
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | assignrecertsubmission_onlinetext_enabled | assignrecertsubmission_file_enabled | duedate    |
      | assignrecert   | C1     | assign1  | Test assignmentrecert name | Test assignmentrecert description | 0                                   | 0                             | 1388534400 |
  ...
  @javascript @_alert
  Scenario: Granting extensions to an offline assignmentrecert (batch action)
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | assignrecertsubmission_onlinetext_enabled | assignrecertsubmission_file_enabled | duedate    |
      | assignrecert   | C1     | assign1  | Test assignmentrecert name | Test assignmentrecert description | 0                                   | 0                             | 1388534400 |
    And I log in as "teacher1"
  ...
  Scenario: Validating that extension date is after due date
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | assignrecertsubmission_onlinetext_enabled | assignrecertsubmission_file_enabled | allowsubmissionsfromdate    | duedate    |
      | assignrecert   | C1     | assign1  | Test assignmentrecert name | Test assignmentrecert description | 0                                   | 0                             | 1388534400                  | 1388620800 |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Test assignmentrecert name"
    When I navigate to "View all submissions" in current page administration
