...
Feature: Prevent or allow assignmentrecert submission changes
  ...
  Scenario: Preventing changes and allowing them again
    ...
    And I should see "This assignmentrecert is not accepting submissions"
    And I log out
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Test assignmentrecert name"
    ...
    And I am on "Course 1" course homepage
    And I follow "Test assignmentrecert name"
    And I should not see "This assignmentrecert is not accepting submissions"
    And I press "Edit submission"
    And I set the following fields to these values:
  ...
  Scenario: Preventing changes and allowing them again (batch action)
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | assignrecertsubmission_onlinetext_enabled | assignrecertsubmission_file_enabled |
      | assignrecert   | C1     | assign1  | Test assignmentrecert name | Test assignmentrecert description | 1                                   | 0                             |
    And I log in as "student1"
    And I am on "Course 1" course homepage
    And I follow "Test assignmentrecert name"
    And I press "Add submission"
