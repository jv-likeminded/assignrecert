...
Feature: Assign activity completion with passing grade
  ...
  Scenario: Require grade is on, require passing grade is on, passing grade is 0
    ...
    Then I should see "Updating: Assignment Recert"
    And I should see "'Grade to pass' must be greater than 0 when 'Require passing grade' activity completion setting is enabled"
    And I should see "This assignmentrecert does not have a grade to pass set so you cannot use this option"
  ...
  Scenario Outline: Test the combination of require passing grade and passing grade
    ...
    When I click on "Save and return to course" "button"
    Then I should not see "Updating: Assignment Recert"

    When I expand "Reports" node
    And I follow "Activity completion"
    Then I should see "One Uno, assignrecert 1: Not completed" in the "One Uno" "table_row"
    And I should see "Two Duex, assignrecert 1: Not completed" in the "Two Duex" "table_row"
    And I should see "Three Toru, assignrecert 1: Not completed" in the "Three Toru" "table_row"
    And I should see "Four Wha, assignrecert 1: Not completed" in the "Four Wha" "table_row"
    And I should see "Five Cinq, assignrecert 1: Not completed" in the "Five Cinq" "table_row"

    # Grade assignmentrecerts
    ...
    Then I should see "One Uno, assignrecert 1: <user1_see_1st>" in the "One Uno" "table_row"
    And I should see "Two Duex, assignrecert 1: <user2_see_1st>" in the "Two Duex" "table_row"
    And I should see "Three Toru, assignrecert 1: <user3_see_1st>" in the "Three Toru" "table_row"
    And I should see "Four Wha, assignrecert 1: <user4_see_1st>" in the "Four Wha" "table_row"
    And I should see "Five Cinq, assignrecert 1: <user5_see_1st>" in the "Five Cinq" "table_row"
    ...
    Then I should see "One Uno, assignrecert 1: <user1_see_2nd>" in the "One Uno" "table_row"
    And I should see "Two Duex, assignrecert 1: <user2_see_2nd>" in the "Two Duex" "table_row"
    And I should see "Three Toru, assignrecert 1: <user3_see_2nd>" in the "Three Toru" "table_row"
    And I should see "Four Wha, assignrecert 1: <user4_see_2nd>" in the "Four Wha" "table_row"
    And I should see "Five Cinq, assignrecert 1: <user5_see_2nd>" in the "Five Cinq" "table_row"
