...
Feature: Assignment Recerts where the grading type is none
  ...
  Scenario: Ensure the correct terminology is being used when the grading type is not set.
    ...
    Then I should see "Assignment Recert does not require a grade"
    When I press "Add submission"
    And I set the following fields to these values:
      | Online text | Hello |
    And I press "Save changes"
    Then I should see "Submitted"
    And I should see "Assignment Recert does not require a grade"
    ...
    Then I should see "Assignment Recert does not require a grade"
    Given I follow "Assignment Recert: Test assignmentrecert name"
