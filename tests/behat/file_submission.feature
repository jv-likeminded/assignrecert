@mod @mod_assignrecert @_file_upload
Feature: In an assignmentrecert, students can upload files for assessment
  In order to complete my assignmentrecerts providing files
  As a student
  ...
  Scenario: Submit a file and update the submission with another file
    ...
    And I add a "Assignment Recert" to section "1" and I fill the form with:
      ...
      | assignrecertsubmission_onlinetext_enabled | 0 |
