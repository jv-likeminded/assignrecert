@mod @mod_assignrecert @totara @editor @editor_weka @weka @vuejs @javascript
Feature: Assignment Recert activity works as expected when Weka is the default editor
  Background:
  ...
  Scenario: JSON content is rendered correctly for assignmentrecerts
    ...
    And I activate the weka editor "Online text"
    ...
    When I activate the weka editor "Feedback comments"
    ...
    And I set the field "search_input" to "Assignment Recert submissions"
    And I click on "button.tw-selectSearchText__btn" "css_element"
    And I click on "div[data-tw-grid-item-id=\"assignrecert-source\"]" "css_element"
    And I wait for pending js
    And I press "Create and edit"
    And I switch to "Columns" tab
    And I add the "Assignment Recert intro" column to the report
  ...
  Scenario: Check word limit and word count on weka editor
    And the following "activities" exist:
      ...
      | assignrecert   | Test assignrecert | C1     | AS516N   |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Test assignrecert"
    And I navigate to "Edit settings" node in "Assignment Recert administration"
    And I expand all fieldsets
    And I set the following fields to these values:
      | File submissions | 0 |
      | Online text      | 1 |
      | id_assignrecertsubmission_onlinetext_wordlimit_enabled |  1 |
      | id_assignrecertsubmission_onlinetext_wordlimit         | 25 |
    ...
    And I click on "Done" "button" in the ".tui-modal" "css_element"
    And I press "Save changes"
    Then I should not see "The word limit for this assignmentrecert is 25 words"
