...
Feature: In an assignmentrecert, teachers can edit feedback for a students previous submission attempt
  ...
  Scenario: Edit feedback for a students previous attempt.
    ...
    And I click on ".mod-assignrecert-history-link" "css_element"
