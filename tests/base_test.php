 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_assignrecert_base_testcase extends advanced_testcase {
    ...
    /** @var stdClass $course New course created to hold the assignmentrecerts */
    ...
    /**
     * Setup function - we will create a course and add an assignrecert instance to it.
     */
    ...
    protected function create_instance($params=array()) {
        ...
        return new mod_assignrecert_testable_assignrecert($context, $cm, $this->course);
    }
...
class_alias('mod_assignrecert_testable_assign', 'testable_assign');
