...
/**
 * The testable assignrecert class.
 *
 ...
 */
class mod_assignrecert_testable_assignrecert extends assignrecert {
    ...
    public function testable_process_set_batch_marking_allocation($selectedusers, $markerid) {
        ...
        mod_assignrecert_batch_set_allocatedmarker_form::mock_submit($data);
    ...
    public function testable_process_set_batch_marking_workflow_state($selectedusers, $state) {
        ...
        mod_assignrecert_batch_set_marking_workflow_state_form::mock_submit($data);
    ...
    public function testable_grading_batch_operations_form($operation, $selectedusers) {
        ...
        mod_assignrecert_grading_batch_operations_form::mock_submit($data);

        // Set required variables in the form.
        $formparams = array();
        $formparams['submissiondrafts'] = 1;
        $formparams['duedate'] = 1;
        $formparams['attemptreopenmethod'] = ASSIGNRECERT_ATTEMPT_REOPEN_METHOD_MANUAL;
        ...
        $mform = new mod_assignrecert_grading_batch_operations_form(null, $formparams);
