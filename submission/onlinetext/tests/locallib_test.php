...
/**
 * Tests for mod/assignrecert/submission/onlinetext/locallib.php
 *
...
/**
 * Unit tests for mod/assignrecert/submission/onlinetext/locallib.php
 *
 * @copyright  2016 Cameron Ball
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignrecertsubmission_onlinetext_locallib_testcase extends advanced_testcase {
    ...
    public function test_submission_is_empty($submissiontext, $expected) {
        ...
        $assignrecert = $this->create_instance($course, [
                'assignrecertsubmission_onlinetext_enabled' => true,
            ]);
    ...
    public function test_new_submission_empty($submissiontext, $expected) {
        ...
        $result = $assignrecert->new_submission_empty((object) [
                'onlinetext_editor' => [
                    'text' => $submissiontext,
                    'format' => FORMAT_HTML
                ],
