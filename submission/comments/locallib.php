 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignrecert_submission_comments extends assignrecert_submission_plugin {
    ...
    public function get_name() {
        return get_string('pluginname', 'assignrecertsubmission_comments');
    }
    ...
    public function view_summary(stdClass $submission, & $showviewlink) {
        ...
        $options->course    = $this->assignmentrecert->get_course();
        $options->context = $this->assignmentrecert->get_context();
        ...
        $o = $this->assignmentrecert->get_renderer()->container($comment->output(true), 'commentscontainer');
        return $o;
    }
