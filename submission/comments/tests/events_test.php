 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignrecertsubmission_comments_events_testcase extends advanced_testcase {
    ...
    public function test_comment_created() {
        ...
        $options->course = $assignrecert->get_course();
        $options->context = $context;
        $options->itemid = $submission->id;
        $options->component = 'assignrecertsubmission_comments';
        ...
        $this->assertInstanceOf('\assignrecertsubmission_comments\event\comment_created', $event);
        $this->assertEquals($context, $event->get_context());
        $url = new moodle_url('/mod/assignrecert/view.php', array('id' => $assignrecert->get_course_module()->id));
    ...
    public function test_comment_deleted() {
        ...
        // Checking that the event contains the expected values.
        $this->assertInstanceOf('\assignrecertsubmission_comments\event\comment_deleted', $event);
        $this->assertEquals($context, $event->get_context());
        $url = new moodle_url('/mod/assignrecert/view.php', array('id' => $assignrecert->get_course_module()->id));
        $this->assertEquals($url, $event->get_url());
        $this->assertEventContextNotUsed($event);
