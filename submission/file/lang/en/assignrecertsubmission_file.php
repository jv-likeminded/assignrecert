...
/**
 * Strings for component 'assignrecertsubmission_file', language 'en'
 *
...
$string['default_help'] = 'If set, this submission method will be enabled by default for all new assignmentrecerts.';
...
$string['maxfiles_help'] = 'If file submissions are enabled, each assignmentrecert can be set to accept up to this number of files for their submission.';
