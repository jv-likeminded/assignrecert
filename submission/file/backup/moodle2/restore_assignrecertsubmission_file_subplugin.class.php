 ...
 * needed to restore one assignrecert_submission subplugin.
 *
 * @package assignrecertsubmission_file
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_assignrecertsubmission_file_subplugin extends restore_subplugin {
     ...
     * @return void
     */
    public function process_assignrecertsubmission_file_submission($data) {
        global $DB;
        ...
        $DB->insert_record('assignrecertsubmission_file', $data);

        $this->add_related_files('assignrecertsubmission_file',
                                 'submission_files',
                                 'submission',
                                 null,
                                 $oldsubmissionid);
