    ...
    initializer: function (config) {
      ...
      link = Y.Node.create(
        '<li><a tabindex="-1" href="#">' +
          M.util.get_string("addtoquicklist", "assignrecertfeedback_editpdf") +
          "</a></li>"
      );
      ...
      link = Y.Node.create(
        '<li><a tabindex="-1" href="#">' +
          M.util.get_string("deletecomment", "assignrecertfeedback_editpdf") +
          "</a></li>"
      );
      link.on(
        "click",
      ...
      this.set(
        "headerText",
        M.util.get_string("commentcontextmenu", "assignrecertfeedback_editpdf")
      );
