YUI.add(
  ...
  function (Y, NAME) {
     ...
     */
    var AJAXBASE =
        M.cfg.wwwroot + "/mod/assignrecert/feedback/editpdf/ajax.php",
      AJAXBASEPROGRESS =
        M.cfg.wwwroot + "/mod/assignrecert/feedback/editpdf/ajax_progress.php",
      CSS = {
        DIALOGUE: "assignrecertfeedback_editpdf_widget",
      },
      SELECTOR = {
    ...
    var POINT = function (x, y) {
       ...
       * @method clip
       * @param M.assignrecertfeedback_editpdf.point
       * @public
       */
    ...
    M.assignrecertfeedback_editpdf.point = POINT;
    // This file is part of Moodle - http://moodle.org/
    //
    // Moodle is free software: you can redistribute it and/or modify
    // it under the terms of the GNU General Public License as published by
    ...
    M.assignrecertfeedback_editpdf = M.assignrecertfeedback_editpdf || {};
    M.assignrecertfeedback_editpdf.rect = RECT;
    // This file is part of Moodle - http://moodle.org/
    //
    // Moodle is free software: you can redistribute it and/or modify
    // it under the terms of the GNU General Public License as published by
    ...
    var EDIT = function () {
       ...
       * @property start
       * @type M.assignrecertfeedback_editpdf.point|false
       * @public
       */
      this.start = false;
       ...
       * @property path
       * @type M.assignrecertfeedback_editpdf.point[]
       * @public
       */
      this.path = [];
    };
    ...
    M.assignrecertfeedback_editpdf = M.assignrecertfeedback_editpdf || {};
    M.assignrecertfeedback_editpdf.edit = EDIT;
    // This file is part of Moodle - http://moodle.org/
    //
    // Moodle is free software: you can redistribute it and/or modify
    // it under the terms of the GNU General Public License as published by
     ...
     *
     * @namespace M.assignrecertfeedback_editpdf
     * @param M.assignrecertfeedback_editpdf.editor editor
     * @class drawable
     */
    var DRAWABLE = function (editor) {
      /**
       * Reference to M.assignrecertfeedback_editpdf.editor.
       * @property editor
       * @type M.assignrecertfeedback_editpdf.editor
       * @public
       */
      this.editor = editor;
    ...
    M.assignrecertfeedback_editpdf = M.assignrecertfeedback_editpdf || {};
    M.assignrecertfeedback_editpdf.drawable = DRAWABLE;
    // This file is part of Moodle - http://moodle.org/
    //
    // Moodle is free software: you can redistribute it and/or modify
    // it under the terms of the GNU General Public License as published by
    ...
    Y.extend(ANNOTATION, Y.Base, {
      ...
      /**
       * Reference to M.assignrecertfeedback_editpdf.drawable
       * @property drawable
       * @type M.assignrecertfeedback_editpdf.drawable
       * @public
       */
      drawable: false,
       ...
       * @return M.assignrecertfeedback_editpdf.drawable
       */
      draw_highlight: function () {
        var bounds,
          ...
          offsetcanvas = this.editor
            .get_dialogue_element(SELECTOR.DRAWINGCANVAS)
            .getXY(),
          shape;

        if (this.editor.currentannotation === this) {
          // Draw a highlight around the annotation.
          bounds = new M.assignrecertfeedback_editpdf.rect();
          bounds.bound([
       ...
       * @public
       * @method draw
       * @return M.assignrecertfeedback_editpdf.drawable|false
       */
      draw: function () {
       ...
       * @param M.assignrecertfeedback_editpdf.edit edit
       */
      ...
      init_from_edit: function (edit) {
        var bounds = new M.assignrecertfeedback_editpdf.rect();
    ...
    M.assignrecertfeedback_editpdf = M.assignrecertfeedback_editpdf || {};
    M.assignrecertfeedback_editpdf.annotation = ANNOTATION;
    // This file is part of Moodle - http://moodle.org/
    //
    // Moodle is free software: you can redistribute it and/or modify
    // it under the terms of the GNU General Public License as published by
     ...
     * @extends M.assignrecertfeedback_editpdf.annotation
     */
    ...
    Y.extend(ANNOTATIONLINE, M.assignrecertfeedback_editpdf.annotation, {
      /**
      ...
      draw: function () {
        ...
        drawable = new M.assignrecertfeedback_editpdf.drawable(this.editor);
       ...
       */
      draw_current_edit: function (edit) {
        var drawable = new M.assignrecertfeedback_editpdf.drawable(this.editor),
          shape;
    ...
    M.assignrecertfeedback_editpdf = M.assignrecertfeedback_editpdf || {};
    M.assignrecertfeedback_editpdf.annotationline = ANNOTATIONLINE;
    // This file is part of Moodle - http://moodle.org/
    //
    // Moodle is free software: you can redistribute it and/or modify
    // it under the terms of the GNU General Public License as published by
    ...
    Y.extend(ANNOTATIONRECTANGLE, M.assignrecertfeedback_editpdf.annotation, {
      /**
      ...
      draw_current_edit: function (edit) {
        ...
        bounds = new M.assignrecertfeedback_editpdf.rect();
        bounds.bound([
          new M.assignrecertfeedback_editpdf.point(edit.start.x, edit.start.y),
          new M.assignrecertfeedback_editpdf.point(edit.end.x, edit.end.y),
        ]);
    ...
    M.assignrecertfeedback_editpdf = M.assignrecertfeedback_editpdf || {};
    M.assignrecertfeedback_editpdf.annotationrectangle = ANNOTATIONRECTANGLE;
    // This file is part of Moodle - http://moodle.org/
    //
    // Moodle is free software: you can redistribute it and/or modify
    // it under the terms of the GNU General Public License as published by
    ...
    Y.extend(ANNOTATIONOVAL, M.assignrecertfeedback_editpdf.annotation, {
      /**
    ...
    M.assignrecertfeedback_editpdf = M.assignrecertfeedback_editpdf || {};
    M.assignrecertfeedback_editpdf.annotationoval = ANNOTATIONOVAL;
    // This file is part of Moodle - http://moodle.org/
    //
    // Moodle is free software: you can redistribute it and/or modify
    // it under the terms of the GNU General Public License as published by
    ...
    Y.extend(ANNOTATIONPEN, M.assignrecertfeedback_editpdf.annotation, {
      /**
       ...
       */
      draw: function () {
        var drawable, shape, first, positions, xy;
      ...
      init_from_edit: function (edit) {
        ...
        for (i = 0; i < edit.path.length; i++) {
          pathlist.push(
            parseInt(edit.path[i].x, 10) + "," + parseInt(edit.path[i].y, 10)
          );
        }
    ...
    M.assignrecertfeedback_editpdf = M.assignrecertfeedback_editpdf || {};
    M.assignrecertfeedback_editpdf.annotationpen = ANNOTATIONPEN;
    // This file is part of Moodle - http://moodle.org/
    //
    // Moodle is free software: you can redistribute it and/or modify
    // it under the terms of the GNU General Public License as published by
    ...
    Y.extend(ANNOTATIONHIGHLIGHT, M.assignrecertfeedback_editpdf.annotation, {
      /**
       ...
       */
      draw: function () {
        var drawable, shape, bounds, highlightcolour;
    ...
    M.assignrecertfeedback_editpdf = M.assignrecertfeedback_editpdf || {};
    M.assignrecertfeedback_editpdf.annotationhighlight = ANNOTATIONHIGHLIGHT;
    // This file is part of Moodle - http://moodle.org/
    //
    // Moodle is free software: you can redistribute it and/or modify
    // it under the terms of the GNU General Public License as published by
    ...
    Y.extend(ANNOTATIONSTAMP, M.assignrecertfeedback_editpdf.annotation, {
      /**
      ...
      draw: function () {
        var drawable = new M.assignrecertfeedback_editpdf.drawable(this.editor),
          drawingcanvas = this.editor.get_dialogue_element(
            SELECTOR.DRAWINGCANVAS
          ),
          node,
          position;

        position = this.editor.get_window_coordinates(
          new M.assignrecertfeedback_editpdf.point(this.x, this.y)
        );
      ...
      draw_current_edit: function (edit) {
        ...
        bounds.bound([edit.start, edit.end]);
        position = this.editor.get_window_coordinates(
          new M.assignrecertfeedback_editpdf.point(bounds.x, bounds.y)
        );
        ...
        node.setStyles({
          ...
          display: "inline-block",
          backgroundImage:
            "url(" + this.editor.get_stamp_image_url(edit.stamp) + ")",
          width: bounds.width,
          height: bounds.height,
          backgroundSize: "100% 100%",
          zIndex: 50,
    ...
    M.assignrecertfeedback_editpdf = M.assignrecertfeedback_editpdf || {};
    M.assignrecertfeedback_editpdf.annotationstamp = ANNOTATIONSTAMP;
    ...
    Y.extend(
      ...
      M.core.dialogue,
      {
        ...
        initializer: function (config) {
          ...
          bb.addClass("assignrecertfeedback_editpdf_dropdown");
          ...
          body.on(
            ...
            function (e) {
              if (this.get("visible")) {
                ...
                if (
                  e.target.get("id") !== button.get("id") &&
                  e.target.ancestor().get("id") !== button.get("id")
                ) {
                  e.preventDefault();
                  this.hide();
                }
    ...
    M.assignrecertfeedback_editpdf = M.assignrecertfeedback_editpdf || {};
    M.assignrecertfeedback_editpdf.dropdown = DROPDOWN;
    ...
    M.assignrecertfeedback_editpdf = M.assignrecertfeedback_editpdf || {};
    M.assignrecertfeedback_editpdf.stamppicker = STAMPPICKER;
    ...
    Y.extend(
      ...
      M.assignrecertfeedback_editpdf.dropdown,
      {
         ...
         */
        initializer: function (config) {
          var commentlinks, link, body, comment;
        ...
        show: function () {
          ...
          Y.each(
            comment.editor.quicklist.comments,
            function (quickcomment) {
              var listitem = Y.Node.create(
                  '<li class="quicklist_comment"></li>'
                ),
                linkitem = Y.Node.create(
                  '<a href="#" tabindex="-1">' + quickcomment.rawtext + "</a>"
                ),
                deletelinkitem = Y.Node.create(
                  '<a href="#" tabindex="-1" class="delete_quicklist_comment">' +
                    '<img src="' +
              ...
              linkitem.on(
                "click",
                comment.set_from_quick_comment,
                comment,
                quickcomment
              );
              linkitem.on(
    ...
    M.assignrecertfeedback_editpdf = M.assignrecertfeedback_editpdf || {};
    M.assignrecertfeedback_editpdf.commentmenu = COMMENTMENU;
    /* eslint-disable no-unused-vars */
    /* global SELECTOR */
    ...
    COMMENTSEARCH = function (config) {
      ...
      config.width = "400px";
      config.visible = false;
      config.headerContent = M.util.get_string(
        "searchcomments",
        "assignrecertfeedback_editpdf"
      );
      config.footerContent = "";
    ...
    Y.extend(
      ...
      M.core.dialogue,
      {
         ...
         */
        initializer: function (config) {
          var editor, container, placeholder, commentfilter, commentlist, bb;

          bb = this.get("boundingBox");
          bb.addClass("assignrecertfeedback_editpdf_commentsearch");
        ...
        filter_search_comments: function () {
          var filternode, commentslist, filtertext, dialogueid;
    ...
    M.assignrecertfeedback_editpdf = M.assignrecertfeedback_editpdf || {};
    M.assignrecertfeedback_editpdf.commentsearch = COMMENTSEARCH;
    // This file is part of Moodle - http://moodle.org/
    //
    // Moodle is free software: you can redistribute it and/or modify
    // it under the terms of the GNU General Public License as published by
    ...
    var COMMENT = function (
       ...
       * @property menu
       * @type M.assignrecertfeedback_editpdf.dropdown
       * @public
       */
      this.menu = null;
        ...
        node.on(
          ...
          function (e) {
            if (editor.currentedit.tool === "select") {
              ...
              newlocation = this.editor.get_canvas_coordinates(
                new M.assignrecertfeedback_editpdf.point(x, y)
              );
    ...
    M.assignrecertfeedback_editpdf = M.assignrecertfeedback_editpdf || {};
    M.assignrecertfeedback_editpdf.comment = COMMENT;
    // This file is part of Moodle - http://moodle.org/
    //
    // Moodle is free software: you can redistribute it and/or modify
    // it under the terms of the GNU General Public License as published by
    ...
    M.assignrecertfeedback_editpdf = M.assignrecertfeedback_editpdf || {};
    M.assignrecertfeedback_editpdf.quickcomment = QUICKCOMMENT;
    // This file is part of Moodle - http://moodle.org/
    //
    // Moodle is free software: you can redistribute it and/or modify
    // it under the terms of the GNU General Public License as published by
    ...
    var QUICKCOMMENTLIST = function (editor) {
       ...
       * Array of Comments
       * @property shapes
       * @type M.assignrecertfeedback_editpdf.quickcomment[]
       * @public
       */
      this.comments = [];
            ...
            success: function (tid, response) {
              ...
              try {
                ...
                if (jsondata.error) {
                  ...
                  quickcomment =
                    new M.assignrecertfeedback_editpdf.quickcomment(
                      jsondata.id,
                      jsondata.rawtext,
                      jsondata.width,
                      jsondata.colour
    ...
    M.assignrecertfeedback_editpdf = M.assignrecertfeedback_editpdf || {};
    M.assignrecertfeedback_editpdf.quickcommentlist = QUICKCOMMENTLIST;
    // This file is part of Moodle - http://moodle.org/
    //
    // Moodle is free software: you can redistribute it and/or modify
    // it under the terms of the GNU General Public License as published by
    ...
    EDITOR.prototype = {
      ...
      initializer: function () {
        ...
        if (link) {
          ...
          require(["mod_assignrecert/grading_review_panel"], function (
            ...
            var panel = panelManager.getReviewPanel(
              "assignrecertfeedback_editpdf"
            );
            if (panel) {
              panel = Y.one(panel);
      ...
      all_pages_loaded: function (responsetext) {
        ...
        for (i = 0; i < this.pages.length; i++) {
          ...
          for (j = 0; j < this.pages[i].annotations.length; j++) {
            ...
            this.pages[i].annotations[j] = this.create_annotation(
              data.type,
              data
            );
          }
      ...
      setup_toolbar: function () {
        ...
        searchcommentsbutton.on(
          "key",
          this.open_search_comments,
          "down:13",
          this
        );
      ...
      handle_tool_button: function (e, tool) {
        ...
        currenttoolnode.removeClass(
          "assignrecertfeedback_editpdf_selectedbutton"
        );
