 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignrecertfeedback_editpdf_widget implements renderable {

    /** @var int $assignmentrecert - Assignment Recert instance id */
    public $assignmentrecert = 0;
    ...
    /**
     * Constructor
     * @param int $assignmentrecert - Assignment Recert instance id
     ...
     */
    public function __construct($assignmentrecert, $userid, $attemptnumber, $downloadurl,
