 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_assignrecertfeedback_editpdf_subplugin extends restore_subplugin {
     ...
     * @param mixed $data
     */
    public function process_assignrecertfeedback_editpdf_files($data) {
        $data = (object)$data;

        // In this case the id is the old gradeid which will be mapped.
        $this->add_related_files('assignrecertfeedback_editpdf',
            \assignrecertfeedback_editpdf\document_services::FINAL_PDF_FILEAREA, 'grade', null, $data->gradeid);
        $this->add_related_files('assignrecertfeedback_editpdf',
            \assignrecertfeedback_editpdf\document_services::PAGE_IMAGE_READONLY_FILEAREA, 'grade', null, $data->gradeid);
        $this->add_related_files('assignrecertfeedback_editpdf', 'stamps', 'grade', null, $data->gradeid);
    }
     ...
     * @param mixed $data
     */
    public function process_assignrecertfeedback_editpdf_annotation($data) {
        global $DB;
        ...
        $DB->insert_record('assignrecertfeedback_editpdf_annot', $data);
     ...
     * @param mixed $data
     */
    public function process_assignrecertfeedback_editpdf_comment($data) {
        global $DB;
        ...
        $DB->insert_record('assignrecertfeedback_editpdf_cmnt', $data);
