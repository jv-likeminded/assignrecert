...
/**
 * Strings for component 'assignrecertfeedback_editpdf', language 'en'
 *
...
$string['enabled_help'] = 'If enabled, the trainer will be able to create annotated PDF files when marking the assignmentrecerts. This allows the trainer to add comments, drawing and stamps directly on top of the learners work. The annotating is done in the browser and no extra software is required.';
...
$string['test_unoconvversionnotsupported'] = 'The version of unoconv you have installed is not supported. Totara\'s assignmentrecert grading feature requires version 0.7 or higher.';
