 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_assignrecertfeedback_editpdf extends behat_base {
    ...
    public function ghostscript_is_installed() {
        ...
        $testpath = assignrecertfeedback_editpdf\pdf::test_gs_path();
        if (!extension_loaded('zlib') or
            $testpath->status !== assignrecertfeedback_editpdf\pdf::GSPATH_OK) {
    ...
    public function i_draw_on_the_pdf() {
        ...
        $js = ' (function() {
    var instance = M.assignrecertfeedback_editpdf.instance;
