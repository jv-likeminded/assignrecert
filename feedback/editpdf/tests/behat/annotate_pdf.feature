@mod @mod_assignrecert @assignrecertfeedback @assignrecertfeedback_editpdf @_file_upload
Feature: In an assignmentrecert, teacher can annotate PDF files during grading
  ...
  Scenario: Submit a PDF file as a student and annotate the PDF as a teacher
    ...
    And I navigate to "Annotate PDF" node in "Site administration > Plugins > Activity modules > Assignment Recert > Feedback plugins"
    ...
    And I upload "mod/assignrecert/feedback/editpdf/tests/fixtures/submission.pdf" file to "File submissions" filemanager
    And I upload "mod/assignrecert/feedback/editpdf/tests/fixtures/testgs.pdf" file to "File submissions" filemanager
