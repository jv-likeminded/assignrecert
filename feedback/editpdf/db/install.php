 ...
 */
function xmldb_assignrecertfeedback_editpdf_install() {
    global $CFG;
    ...
    $filerecord->component = 'assignrecertfeedback_editpdf';
    ...
    foreach ($defaultstamps as $stamp) {
        ...
        $fs->create_file_from_pathname($filerecord,
            $CFG->dirroot . '/mod/assignrecert/feedback/editpdf/pix/' . $filerecord->filename);
    }
}
