 ...
 *
 * Provides the necessary information needed to restore
 * one assignrecertfeedback subplugin.
 *
 * @package   assignrecertfeedback_comments
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_assignrecertfeedback_comments_subplugin extends restore_subplugin {
     ...
     * @param mixed $data
     */
    public function process_assignrecertfeedback_comments_grade($data) {
        global $DB;
        ...
        $DB->insert_record('assignrecertfeedback_comments', $data);
    }
}
