...
/**
 * Unit tests for assignrecertfeedback_comments
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignrecertfeedback_comments_testcase extends advanced_testcase {
    ...
    public function test_is_feedback_modified() {
        ...
        // Change the data.
        $data->assignrecertfeedbackcomments_editor = [
