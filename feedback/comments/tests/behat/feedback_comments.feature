@mod @mod_assignrecert @assignrecertfeedback @assignrecertfeedback_comments
Feature: In an assignmentrecert, teachers can provide feedback comments on student submissions
  In order to provide feedback to students on their assignmentrecerts
  As a teacher,
  ...
  Scenario: Teachers should be able to add and remove feedback comments via the quick grading interface
    Given the following "activities" exist:
      | activity | course | idnumber | name             | assignrecertsubmission_onlinetext_enabled | assignrecertfeedback_comments_enabled |
      | assignrecert   | C1     | assign1  | Test assignment1 | 1                                   | 1                               |
