...
$string['default_help'] = 'If set, this feedback method will be enabled by default for all new assignmentrecerts.';
$string['enabled'] = 'File feedback';
$string['enabled_help'] = 'If enabled, the trainer will be able to upload files with feedback when marking the assignmentrecerts. These files may be, but are not limited to marked up learner submissions, documents with comments or spoken audio feedback.';
