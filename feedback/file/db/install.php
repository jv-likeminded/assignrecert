...
/**
 * Post-install code for the assignrecertfeedback_file module.
 *
...
/**
 * Code run after the assignrecertfeedback_file module database tables have been created.
 * Moves the feedback file plugin down
 *
 * @return bool
 */
function xmldb_assignrecertfeedback_file_install() {
    global $CFG;
