...
/**
 * Unit tests for assignrecertfeedback_file
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignrecertfeedback_file_testcase extends advanced_testcase {
    ...
    public function test_is_feedback_modified() {
        ...
        file_prepare_draft_area($draftitemid, $context->id, 'assignrecertfeedback_file', 'feedback_files', 1);
        ...
        $plugin = $assignrecert->get_feedback_plugin_by_type('file');
