...
/**
 * The mod_assignrecert grading table viewed event.
 *
...
/**
 * The mod_assignrecert grading table viewed event class.
 *
...
class grading_table_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventgradingtableviewed', 'mod_assignrecert');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the grading table for the assignmentrecert with course module " .
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewsubmissiongradingtable', 'assignrecert');
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call grading_table_viewed::create() directly, use grading_table_viewed::create_from_assignrecert() instead.');
        }
