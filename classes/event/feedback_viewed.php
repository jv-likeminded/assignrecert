...
/**
 * The mod_assignrecert feedback viewed event.
 *
...
/**
 * The mod_assignrecert feedback viewed event class.
 *
...
class feedback_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventfeedbackviewed', 'mod_assignrecert');
    }
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewfeedbackforuser', 'assignrecert', $this->relateduserid);
