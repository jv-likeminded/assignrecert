...
/**
 * The mod_assignrecert submission viewed event.
 *
...
/**
 * The mod_assignrecert submission viewed event class.
 *
...
class submission_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionviewed', 'mod_assignrecert');
    }
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewsubmissionforuser', 'assignrecert', $this->relateduserid);
