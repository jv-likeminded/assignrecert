...
/**
 * The mod_assignrecert submission status viewed event.
 *
...
/**
 * The mod_assignrecert submission status viewed event class.
 *
...
class submission_status_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionstatusviewed', 'mod_assignrecert');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has viewed the submission status page for the assignmentrecert with " .
    ...
    protected function get_legacy_logdata() {
        $this->set_legacy_logdata('view', get_string('viewownsubmissionstatus', 'assignrecert'));
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call submission_status_viewed::create() directly, use submission_status_viewed::create_from_assignrecert() instead.');
        }
