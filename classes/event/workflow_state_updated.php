...
/**
 * mod_assignrecert workflow state updated event.
 *
...
/**
 * mod_assignrecert workflow state updated event class.
 *
...
class workflow_state_updated extends base {
     ...
     */
    public static function create_from_user(\assignrecert $assignrecert, \stdClass $user, $state) {
        $data = array(
    ...
    public function get_description() {
        return "The user with id '$this->userid' has set the workflow state of the user with id '$this->relateduserid' " .
            "to the state '{$this->other['newstate']}' for the assignmentrecert with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventworkflowstateupdated', 'mod_assignrecert');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('setmarkingworkflowstateforlog', 'assignrecert', $a);
