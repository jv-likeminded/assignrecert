...
/**
 * The mod_assignrecert submission unlocked event.
 *
...
/**
 * The mod_assignrecert submission unlocked event class.
 *
 * @package    mod_assignrecert
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_unlocked extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionunlocked', 'mod_assignrecert');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('unlocksubmissionforstudent', 'assignrecert', array('id' => $user->id, 'fullname' => fullname($user)));
