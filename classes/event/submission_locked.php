...
/**
 * The mod_assignrecert submission locked event.
 *
...
/**
 * The mod_assignrecert submission locked event class.
 *
 * @package    mod_assignrecert
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_locked extends base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' locked the submission for the user with id '$this->relateduserid' for " .
            "the assignmentrecert with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventsubmissionlocked', 'mod_assignrecert');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('locksubmissionforstudent', 'assignrecert', array('id' => $user->id, 'fullname' => fullname($user)));
