...
/**
 * The mod_assignrecert submission form viewed event.
 *
...
/**
 * The mod_assignrecert submission form viewed event class.
 *
...
class submission_form_viewed extends base {
     ...
     */
    public static function create_from_user(\assignrecert $assignrecert, \stdClass $user) {
        $data = array(
    ...
    public static function get_name() {
        return get_string('eventsubmissionformviewed', 'mod_assignrecert');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' viewed their submission for the assignmentrecert with course module id " .
    ...
    protected function get_legacy_logdata() {
        if ($this->relateduserid == $this->userid) {
            ...
            $title = get_string('editsubmissionother', 'assignrecert', fullname($user));
        }
        $this->set_legacy_logdata('view submit assignmentrecert form', $title);
